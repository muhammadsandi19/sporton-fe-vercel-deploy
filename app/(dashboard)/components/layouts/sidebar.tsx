  ...
  return (
    <aside className="w-80 min-h-screen bg-white border-r border-gray-100 flex flex-col fixed left-0 top-0">
          ...
          return (
            <Link
              ...
              className={`flex gap-3 items-center py-3 px-4.5 rounded-lg font-medium duration-300 ${
                isActive ? "bg-primary/15 text-primary" : "hover:bg-gray-200"
              }`}
            >
              <item.icon size={24} />
              <span>{item.name}</span>
      ...
      <button
        ...
        className="flex cursor-pointer gap-3 font-medium py-3 px-4.5 mx-5 hover:bg-gray-200 duration-300 rounded-lg mt-auto mb-10"
      >
        <FiLogOut size={24} />
        Log Out
      </button>
